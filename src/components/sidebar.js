...
const NAV_ITEMS = [
  ...
  // ── Phase Four: The Oracle ──
  { section: 'nav.sections.studiesAnalysisChapter', items: [
    { key: 'demand-planning', icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>`, label: 'nav.demandPlanning', route: 'demand-planning' },
    { key: 'cost-engineering', icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>`, label: 'nav.costEngineering', route: 'cost-engineering' },
    { key: 'spend-analysis', icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/></svg>`, label: 'nav.spendAnalysis', route: 'spend-analysis' },
    { key: 'intelligent-reporting', icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>`, label: 'nav.intelligentReporting', route: 'intelligent-reporting' },
  ]},
